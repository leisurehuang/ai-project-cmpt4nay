...
```
  ...
  frontend/public/assets/images/costumes/
  frontend/public/assets/images/hero/
  frontend/public/assets/images/hero/og-cover.svg
  frontend/public/assets/images/history/
  frontend/public/assets/images/icons/
  frontend/public/assets/images/icons/chou.svg
  frontend/public/assets/images/icons/dan.svg
  frontend/public/assets/images/icons/jing.svg
  frontend/public/assets/images/icons/sheng.svg
  frontend/public/assets/images/makeup/
  frontend/public/assets/images/patterns/
  frontend/public/assets/images/patterns/cloud-pattern.svg
  ...
  frontend/src/components/gallery/GalleryApp.vue
  frontend/src/components/gallery/GalleryFilter.vue
  ...
  frontend/src/components/layout/Divider.astro
  ...
  frontend/src/components/ui/Divider.astro
...
```bash
git clone https://github.com/leisurehuang/ai-project-cmpt4nay.git
cd ai-project-cmpt4nay
# 根据项目技术栈安装依赖并运行
```
